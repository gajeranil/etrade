        ...
        <>
            <div>
                ...
                <section className='IMAGES-AND-DISCRIPTION  bg-[#F9F3F0]'>
                    <div className='grid grid-cols-2 gap-16 py-[100px] container mx-auto '>
                        ...
                        <div className='main-div-photos grid grid-cols-2 gap-5'>
                            ...
                            <img className='rounded-md bg-cover' src="./src/assets/shop/p1/asset 3.png" alt="" />
                            <img className='rounded-md bg-cover' src="./src/assets/shop/p1/asset 4.png" alt="" />
                            <img className='rounded-md bg-cover' src="./src/assets/shop/p1/asset 5.png" alt="" />
                            <img className='rounded-md bg-cover' src="./src/assets/shop/p1/asset 5.png" alt="" />
                            <img className='rounded-md bg-cover' src="./src/assets/shop/p1/asset 6.png" alt="" />
                            <img className='rounded-md bg-cover' src="./src/assets/shop/p1/asset 7.png" alt="" />
                            <img className='rounded-md bg-cover' src="./src/assets/shop/p1/asset 8.png" alt="" />
                                ...
                                <div className='flex'>
                                    <div className='mr-10'>
                                        <div className='flex justify-center items-center h-16 w-16 bg-white rounded-full mb-5'>
                                            <img className='h-8' src="./src/assets/shop/p1/asset 11.png" alt="" />
                                        </div>
                                        <h1 className='font-semibold text-xl text-[#292930]'>Easy Returns</h1>
                                    </div>
                                    <div className='mr-10'>
                                        <div className='flex justify-center items-center h-16 w-16 bg-white rounded-full mb-5'>
                                            <img className='h-8' src="./src/assets/shop/p1/asset 12.png" alt="" />
                                        </div>
                                        <h1 className='font-semibold text-xl text-[#292930]'>Quality Service</h1>
                                    </div>
                                    <div>
                                        <div className='flex justify-center items-center h-16 w-16 bg-white rounded-full mb-5'>
                                            <img className='h-8' src="./src/assets/shop/p1/asset 13.png" alt="" />
                                        </div>
