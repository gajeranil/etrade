...
import pimage from '../../assets/blog/video-post/asset 2.jpeg'
    ...
    return (
        <>
            <div>
                ...
                <div className="Standard-section mx-10 container -z-10 ">
                    <div className="Image flex justify-center  mt-20 mx-20  relative mb-10 after:absolute after:content-[''] after:w-[100%] after:h-[100%] after:bg-black after:top-0 after:left-0 after:right-0 after:bottom-0 after:rounded-md after:opacity-[0.2] after:z-10">
                        <img className="rounded-md w-[1150px] " src={pimage}></img>
                        <a href="https://www.youtube.com/watch?v=Youugn7xW_A&list=RDYouugn7xW_A&start_radio=1" target="_blank" className="absolute top-[50%] -translate-x-2/4 -translate-y-2/4 left-[50%]   mx-auto z-20 rounded-full  bg-black  hover:opacity-80"><i class="fa-solid fa-play w-40 h-40 text-4xl z-30 text-white  flex justify-center items-center opacity-100 "></i> </a>
                    </div>

                    <div className="Main-section flex mx-14">
                        <div className="Left-section  mx-5 mt-12">
                    ...
                    <div className="Hot-News-Section mt-20 mx-20 ">
